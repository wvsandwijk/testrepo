...
## SYNOPSIS
Removes the install set.

## SYNTAX

```
Remove-HPEiLOInstallSet [-Connection] <Connection[]> -Name <String[]> [-OutputType <String>] [-Force]
 [<CommonParameters>]
```

## DESCRIPTION
The Remove-HPEiLOInstallSet cmdlet removes the install set.
...
PS C:\> ,$connection | Remove-HPEiLOInstallSet -Name TestInstallSet
```
...
PS C:\> Remove-HPEiLOInstallSet -Connection $connection -Name TestInstallSet
```
