...
## SYNOPSIS
Removes the SNMP alert destination.

## SYNTAX

```
Remove-HPEiLOSNMPAlertDestination [-Connection] <Connection[]> -ID <UInt32[]> [-OutputType <String>] [-Force]
 [<CommonParameters>]
```

## DESCRIPTION
The Remove-HPEiLOSNMPAlertDestination removes the SNMP Alert destination.
...
PS C:\> ,$connection | Remove-HPEiLOSNMPAlertDestination -ID 2
```
...
PS C:\> Remove-HPEiLOSNMPAlertDestination -Connection $connection -ID 2
```
