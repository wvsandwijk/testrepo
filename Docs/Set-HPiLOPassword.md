...
```
Set-HPiLOPassword [-OutputType <String>] [-Username <Object>] [-Password <Object>] [-Credential <Object>]
 [-Force] [-Server <Object>] [-UserLoginToEdit <Object>] [-NewPassword <Object>] [<CommonParameters>]
```

## DESCRIPTION
The Set-HPiLOPassword cmdlet modifies an existing local user account.
The password of local user is modified with this cmdlet.
The UserLoginToEdit parameter must exist in the current user database.
You must have Administer User Accounts privilege, otherwise you can only modify their individual account password.
...
UserLogin To Edit is not provided for the following iLO Server(s):
1.4.217.131
1.4.217.187
1.4.209.53
Edit same User Login on these servers? (Y/N) : N
Enter User Login To Edit for 1.4.217.131: suzylee
Enter User Login To Edit for 1.4.217.187: alansmith
Enter User Login To Edit for 1.4.209.53: timhorton
...
### EXAMPLE 2
```
PS C:\> Set-HPiLOPassword -Server $Server -Username $Username -Password $Password -UserLoginToEdit $UserLoginToEdit -NewPassword $newPassword
```
...
### -UserLoginToEdit
It is the name used to gain access to iLO.
...
### -NewPassword
It is the new password value to be set for the user
...
Without this parameter, Set-HPiLOPassword requires you to provide the values of all required parameters.
