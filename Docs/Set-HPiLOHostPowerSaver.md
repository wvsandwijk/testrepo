...
```
Set-HPiLOHostPowerSaver [-OutputType <String>] [-Username <Object>] [-Password <Object>] [-Credential <Object>]
 [-Force] [-Server <Object>] [-PowerSaver <Object>] [<CommonParameters>]
```

## DESCRIPTION
The Set-HPiLOHostPowerSaver cmdlet sets the Power Regulator Setting for the server processor.
...
Host Power Saver Value is not provided for the following iLO Server(s):
1.4.217.131
1.4.217.187
1.4.209.53
Use same Host Power Saver for these servers? (Y/N) : N
Enter Host Power Saver value for 1.4.217.131: 1
Enter Host Power Saver value for 1.4.217.187: 2
Enter Host Power Saver value for 1.4.209.53: 2
```
...
### EXAMPLE 2
```
PS C:\> Set-HPiLOHostPowerSaver -Server $Server -PowerSaver $PowerSaver
...
$Server is passed as parameter to Set-HPiLOHostPowerSaver.
...
### EXAMPLE 3
```
PS C:\> Set-HPiLOHostPowerSaver -Server $Server -Username $Username -Password $Password -PowerSaver $PowerSaver
```
...
Without this parameter, Set-HPiLOHostPowerSaver requires you to provide the values of all required parameters.
