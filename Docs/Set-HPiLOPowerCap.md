...
```
Set-HPiLOPowerCap [-OutputType <String>] [-Username <Object>] [-Password <Object>] [-Credential <Object>]
 [-Force] [-Server <Object>] [-PowerCap <Object>] [<CommonParameters>]
```

## DESCRIPTION
The Set-HPiLOPowerCap cmdlet sets a power cap on the server.
You must have Configure iLO Settings privilege to execute this command or to modify the power cap.
...
Powercap is not provided for the following iLO Server(s):
1.4.217.131
1.4.217.187
1.4.209.53
Use same powercap for these servers? (Y/N) : N
Enter Powercap value for 1.4.217.131: 300
Enter Powercap value for 1.4.217.187: 300
Enter Powercap value for 1.4.209.53: 100
```
...
### EXAMPLE 2
```
PS C:\> Set-HPiLOPowerCap -Server $Server -PowerCap 200
...
$Server is passed as parameter to Set-HPiLOPowerCap.
...
### EXAMPLE 3
```
PS C:\> Set-HPiLOPowerCap -Server $Server -Username $Username -Password $Password -PowerCap $PowerCap
```
...
Without this parameter, Set-HPiLOPowerCap requires you to provide the values of all required parameters.
