...
```
Clear-HPiLOAHSData [-OutputType <String>] [-Username <Object>] [-Password <Object>] [-Credential <Object>]
 [-Force] [-Server <Object>] [<CommonParameters>]
```

## DESCRIPTION
The Clear-HPiLOAHSData cmdlet clears the Active Health System information from the AHS log.
...
### EXAMPLE 2
```
PS C:\> Clear-HPiLOAHSData -Server $server
...
$Server is passed as parameter to Clear-HPiLOAHSData.
...
### EXAMPLE 3
```
PS C:\> Clear-HPiLOAHSData -Server $Server -Username $Username -Password $Password
```
...
Without this parameter, Clear-HPiLOAHSData requires you to provide the values of all required parameters.
