...
```
Reset-HPiLOAdministratorPassword [-OutputType <String>] [-Username <Object>] [-Password <Object>]
 [-Credential <Object>] [-Force] [-Server <Object>] [-NewPassword <Object>] [<CommonParameters>]
```

## DESCRIPTION
The Reset-HPiLOAdministratorPassword cmdlet sets a default administrator account password.
This command assumes that there is an Administrator account because it is not intended to create one.
...
### EXAMPLE 1
```
PS C:\> Reset-HPiLOAdministratorPassword
...
1.4.217.187
1.4.209.53
Use same new password on these servers? (Y/N) : N
Enter new Password for 1.4.217.131 (iloqwc.company.net): ************
Enter new Password for 1.4.217.187 (ilo.company.net): ************
Enter new Password for 1.4.209.53 (ilomxq.company.net): ************
```
...
### EXAMPLE 2
```
PS C:\> Reset-HPiLOAdministratorPassword -Server $Server -newPassword $newPassword
...
This command takes parameters for new password.
$Server is passed as parameter to Reset-HPiLOAdministratorPassword.
...
### EXAMPLE 3
```
PS C:\> Reset-HPiLOAdministratorPassword -Server $Server -Username $Username -Password $Password -NewPassword $newPassword
```
...
The username and password will be ignored for this cmdlet
...
### -NewPassword
It is the new password value to be set for the Administrator account
...
Without this parameter, Reset-HPiLOAdministratorPassword requires you to provide the values of all required parameters.
