...
## SYNOPSIS
Disables Insight Remote Support functionality and un-registers the server.
(C) Copyright 2013, 2014 Hewlett-Packard Development Company, L.P.

## SYNTAX

```
Disable-HPiLOERSIRSConnection [-OutputType <String>] [-Username <Object>] [-Password <Object>]
 [-Credential <Object>] [-Force] [-Server <Object>] [<CommonParameters>]
```

## DESCRIPTION
The Disable-HPilOERSIRSConnection cmdlet disables Insight Remote Support functionality and un-registers the server.
...
### EXAMPLE 1
```
PS C:\> Disable-HPilOERSIRSConnection
...
### EXAMPLE 2
```
PS C:\> Disable-HPilOERSIRSConnection -Server $server
...
$Server is passed as parameter to Disable-HPilOERSIRSConnection.
...
### EXAMPLE 3
```
PS C:\> Disable-HPilOERSIRSConnection -Server $Server -Username $Username -Password $Password
```
...
Without this parameter, Disable-HPilOERSIRSConnection requires you to provide the values of all required parameters.
