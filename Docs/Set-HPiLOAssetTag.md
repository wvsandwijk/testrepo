...
```
Set-HPiLOAssetTag [-OutputType <String>] [-Username <Object>] [-Password <Object>] [-Credential <Object>]
 [-Force] [-Server <Object>] [-AssetTag <Object>] [<CommonParameters>]
```

## DESCRIPTION
The Set-HPiLOAssetTag cmdlet sets or clears the asset tag.
You must have VirtualMedia, ResetServer, and RemoteCons privileges to execute this command
...
Asset Tag is not provided for the following iLO Server(s):
1.4.217.131
1.4.217.187
1.4.209.53
Use same Asset Tag for these servers? (Y/N) : N
Enter Asset Tag for 1.4.217.131: S0012345
Enter Asset Tag for 1.4.217.187: S0054321
Enter Asset Tag for 1.4.209.53: S56789
```
...
### EXAMPLE 2
```
PS C:\> Set-HPiLOAssetTag -Server $Server
...
$Server is passed as parameter to Set-HPiLOAssetTag.
...
### EXAMPLE 3
```
PS C:\> Set-HPiLOAssetTag -Server $Server -Username $Username -Password $Password -AssetTag $AssetTag
```
...
The parameter value can have upto a maximum length of 32 characters.
...
Without this parameter, Set-HPiLOAssetTag requires you to provide the values of all required parameters.
