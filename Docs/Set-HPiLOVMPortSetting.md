...
```
Set-HPiLOVMPortSetting [-OutputType <String>] [-Username <Object>] [-Password <Object>] [-Credential <Object>]
 [-Force] [-Server <Object>] [-Port <Object>] [<CommonParameters>]
```

## DESCRIPTION
The Set-HPiLOVMPortSetting cmdlet configures the virtual media port functionality for the iLO.
You must have Configure iLO Settings privilege to execute this command.
A list of servers(with or without port number) and corresponding username/password or credential values must be provided as parameters.
WARNING: When this cmdlet is successfully executed, the iLO management processor reboots to apply the changes.

## EXAMPLES

### EXAMPLE 1
```
PS C:\> Set-HPiLOVMPortSetting
...
Port for virtual machine is not provided for the following iLO Server(s):
1.4.217.131
1.4.217.187
1.4.209.53
Use same virtual machine port number for these servers? (Y/N) : N
Enter Port for virtual machine for 1.4.217.131: 10388
Enter Port for virtual machine for 1.4.217.187: 19379
Enter Port for virtual machine for 1.4.209.53: 17883
```
...
### EXAMPLE 2
```
PS C:\> Set-HPiLOVMPortSetting -Server $Server
...
Virtual machine port is not provided for the following iLO Server(s):
1.4.217.131
1.4.217.187
1.4.209.53
Use same virtual machine port number for these servers? (Y/N) : Y
Please enter Virtual machine port: 10388
```

$Server is passed as parameter to Set-HPiLOVMPortSetting.
...
### EXAMPLE 3
```
PS C:\> Set-HPiLOVMPortSetting -Server $Server -Username $Username -Password $Password -Port $Port
```
...
The Port value specifies TCP port number which Virtual Media Service listens.
Change of port value results in reset of iLO
NOTE: When the port is enabled, it allows the Integrated Remote Console and the Virtual Media applet client to connect to the iLO 2 Virtual Media Service.
However, this setting does NOT affect the Scriptable Virtual Media feature.
...
Without this parameter, Set-HPiLOVMPortSetting requires you to provide the values of all required parameters.
