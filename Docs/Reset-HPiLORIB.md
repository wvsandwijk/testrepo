...
```
Reset-HPiLORIB [-OutputType <String>] [-Username <Object>] [-Password <Object>] [-Credential <Object>] [-Force]
 [-Server <Object>] [<CommonParameters>]
```

## DESCRIPTION
The Reset-HPiLORIB cmdlet resets (reboot) the iLO.
You must have Configure iLO settings privilege to execute the command.
...
### EXAMPLE 2
```
PS C:\> Reset-HPiLORIB -Server $Server
...
$Server is passed as parameter to Reset-HPiLORIB.
...
### EXAMPLE 3
```
PS C:\> Reset-HPiLORIB -Server $Server -Username $Username -Password $Password
```
...
Without this parameter, Reset-HPiLORIB requires you to provide the values of all required parameters.
