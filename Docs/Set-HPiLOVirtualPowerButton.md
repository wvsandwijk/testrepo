...
## SYNOPSIS
Simulates the physical press of the power button, press and hold of the power button, coldboot and warm boot of the server.
(C) Copyright 2013, 2014 Hewlett-Packard Development Company, L.P.

## SYNTAX

```
Set-HPiLOVirtualPowerButton [-OutputType <String>] [-Username <Object>] [-Password <Object>]
 [-Credential <Object>] [-Force] [-Server <Object>] [-PressType <Object>] [<CommonParameters>]
```

## DESCRIPTION
The Set-HPiLOVirtualPowerButton cmdlet simulates the physical press, press and hold, cold and warm boot of a server.
You must have Virtual Power and Reset privilege to execute this command.
...
### EXAMPLE 1
```
PS C:\> Set-HPiLOVirtualPowerButton
...
Power button press type is not provided for the following iLO Server(s):
1.4.217.131
1.4.217.187
1.4.209.53
Use same power button press type for these servers? (Y/N) : Y
Enter power buton press type: Hold
```
...
### EXAMPLE 2
```
PS C:\> Set-HPiLOVirtualPowerButton -Server $Server
...
$Server is passed as parameter to Set-HPiLOVirtualPowerButton.
...
### EXAMPLE 3
```
PS C:\> Set-HPiLOVirtualPowerButton -Server $Server -Username $Username -Password $Password -PressType $PressType
```
...
### -PressType
- Press: Simulates a physical momentary press of the server power button.
- Hold: Simulates a physical press and hold of the server power button.
- ColdBoot: Forces a cold boot of the server if the server is on.
- WarmBoot: Forces a warm boot of the server if the server is on.
- Toggle: Turns the server power OFF if it is ON or it turn the power ON if it is OFF
...
Without this parameter, Set-HPiLOVirtualPowerButton requires you to provide the values of all required parameters.
