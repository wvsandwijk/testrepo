...
```
Set-HPiLOLockConfiguration [-OutputType <String>] [-Username <Object>] [-Password <Object>]
 [-Credential <Object>] [-Force] [-Server <Object>] [-LockConfig <Object>] [-F8LoginRequired <Object>]
 [<CommonParameters>]
```

## DESCRIPTION
The Set-HPiLOLockConfiguration cmdlet enables the data-center configuration lock for iLO.
...
### EXAMPLE 1
```
PS C:\> Set-HPiLOLockConfiguration
...
Lock Config is not provided for the following iLO Server(s):
1.4.217.131
1.4.217.187
1.4.209.53
Use same Lock Config for these servers? (Y/N) : Y
Please enter Lock Config : Y

F8 Login required is not provided for the following iLO Server(s):
1.4.217.131
1.4.217.187
1.4.209.53
Use same F8 Login required for these servers? (Y/N) : Y
Please enter F8 Login required value : Y
```
...
### EXAMPLE 2
```
PS C:\> Set-HPiLOLockConfiguration -Server $Server -LockConfig $LockConfig -F8LoginRequired $F8LoginRequired
...
This command takes parameters for LockConfig and F8LoginRequired.
$Server is passed as parameter to Set-HPiLOLockConfiguration.
...
### EXAMPLE 3
```
PS C:\> Set-HPiLOLockConfiguration -Server $Server -Username $Username -Password $Password -LockConfig $LockConfig -F8LoginRequired $F8LoginRequired
```
...
### -LockConfig
Alters the datacenter configuration lock.
Possible values are:
N, No or Disable - default; Disables the lock
Y, Yes or Enable - Enables the lock; authentication is required
...
### -F8LoginRequired
Alters the RBSU login requirement.
Possible values are:
N or No - default; Allow access to iLO RBSU without login
Y or Yes - Require login  to iLO RBSU
...
Without this parameter, Set-HPiLOLockConfiguration requires you to provide the values of all required parameters.
