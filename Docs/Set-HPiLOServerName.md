...
## SYNOPSIS
Assigns the Server Name attribute shown in the user interface and host RBSU.
(C) Copyright 2013, 2014 Hewlett-Packard Development Company, L.P.

## SYNTAX

```
Set-HPiLOServerName [-OutputType <String>] [-Username <Object>] [-Password <Object>] [-Credential <Object>]
 [-Force] [-Server <Object>] [-ServerName <Object>] [<CommonParameters>]
```

## DESCRIPTION
The Set-HPiLOServerName cmdlet assigns the Server Name attribute shown in the user interface and host RBSU.
This setting is not forwarded to the host operating system and does not affect the host operating system.
You must have Configure iLO Settings privilege to change this attribute using the scripting interface.
...
Server name is not provided for the following iLO Server(s):
1.4.217.131
1.4.217.187
1.4.209.53
Use same Server name for these servers? (Y/N) : N
Enter Server name for 1.4.217.131: iLOServer01
Enter Server name for 1.4.217.187: iLOServer02
Enter Server name for 1.4.209.53: iLOServer03
```
...
### EXAMPLE 2
```
PS C:\> Set-HPiLOServerName -Server $Server -ServerName $servername
...
$Server is passed as parameter to Set-HPiLOServerName.
...
### EXAMPLE 3
```
PS C:\> Set-HPiLOServerName -Server $Server -Username $Username -Password $Password -ServerName $ServerName
```
...
### -ServerName
Specifies the value to use as the server name.
...
Without this parameter, Set-HPiLOServerName requires you to provide the values of all required parameters.
