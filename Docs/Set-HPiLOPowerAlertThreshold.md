...
```
Set-HPiLOPowerAlertThreshold [-OutputType <String>] [-Username <Object>] [-Password <Object>]
 [-Credential <Object>] [-Force] [-Server <Object>] [-Type <Object>] [-Threshold <Object>] [-Duration <Object>]
 [<CommonParameters>]
```

## DESCRIPTION
The Set-HPiLOPowerAlertThreshold cmdlet sets the power alert threshold for iLO devices.
...
### EXAMPLE 1
```
PS C:\> Set-HPiLOPowerAlertThreshold
...
Type value is not provided for the following iLO Server(s):
1.4.217.131
1.4.217.187
1.4.209.53
Use same Type value for these servers? (Y/N) : N
Enter Type value for 1.4.217.131: PEAK
Enter Type value for 1.4.217.187: PEAK
Enter Type value for 1.4.209.53: PEAK

Threshold is not provided for the following iLO Server(s):
1.4.217.131
1.4.217.187
1.4.209.53
Use same Threshold value for these servers? (Y/N) : N
Enter Threshold value for 1.4.217.131: 200
Enter Threshold value for 1.4.217.187: 200
Enter Threshold value for 1.4.209.53: 100

Duration is not provided for the following iLO Server(s):
1.4.217.131
1.4.217.187
1.4.209.53
Use same Duration value for these servers? (Y/N) : N
Enter Duration value for 1.4.217.131: 20
Enter Duration value for 1.4.217.187: 20
Enter Duration value for 1.4.209.53: 10
```
...
### EXAMPLE 2
```
PS C:\> Set-HPiLOPowerAlertThreshold -Server $server -Type PEAK -Threshold $Threshold -Duration $Duration
...
$Server is passed as parameter to Set-HPiLOPowerAlertThreshold.
...
### EXAMPLE 3
```
PS C:\> Set-HPiLOPowerAlertThreshold -Server $Server -Username $Username -Password $Password -Type $Type -Threshold $Threshold -Duration $Duration
```
...
Without this parameter, Set-HPiLOPowerAlertThreshold requires you to provide the values of all required parameters.
