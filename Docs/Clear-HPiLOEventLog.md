...
```
Clear-HPiLOEventLog [-OutputType <String>] [-Username <Object>] [-Password <Object>] [-Credential <Object>]
 [-Force] [-Server <Object>] [<CommonParameters>]
```

## DESCRIPTION
The Clear-HPiLOEventLog cmdlet clears the iLO event logs.
...
$Server is passed as parameter to Clear-HPiLOEventLog.
...
### EXAMPLE 3
```
PS C:\> Clear-HPiLOEventLog -Server $Server -Username $Username -Password $Password
```
...
Without this parameter, Clear-HPiLOEventLog requires you to provide the values of all required parameters.
