...
```
Set-HPiLOBrownout [-OutputType <String>] [-Username <Object>] [-Password <Object>] [-Credential <Object>]
 [-Force] [-Server <Object>] [-Enable <Object>] [<CommonParameters>]
```

## DESCRIPTION
The Set-HPiLOBrownout cmdlet turns the brownout recovery feature on or off.
...
Enable is not provided for the following iLO Server(s):
1.4.217.131
1.4.217.187
1.4.209.53
Use same Enable for these servers? (Y/N) : N
Enter Enable for 1.4.217.131: Y
Enter Enable for 1.4.217.187: Y
Enter Enable for 1.4.209.53: N
```
...
### EXAMPLE 2
```
PS C:\> Set-HPiLOBrownout -Server $Server
...
1.4.217.187
1.4.209.53
Use same Enable for these servers? (Y/N) : Y
Please enter value for Enable : Y
```

$Server is passed as parameter to Set-HPiLOBrownout.
...
### EXAMPLE 3
```
PS C:\> Set-HPiLOBrownout -Server $Server -Username $Username -Password $Password -Enable $Enable
```

This command shows that the list of iLO server addresses is passed as a parameter along with usernames, passwords and Yes or No values for Enable.
...
### -Enable
Enables or Disables the brownout recovery.
Possible values are Yes, Enable and On to enable brownout recovery or No, Disable and Off to disable brownout recovery
...
Without this parameter, Set-HPiLOBrownout requires you to provide the values of all required parameters.
