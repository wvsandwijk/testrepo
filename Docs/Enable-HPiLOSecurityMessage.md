...
```
Enable-HPiLOSecurityMessage [-OutputType <String>] [-Username <Object>] [-Password <Object>]
 [-Credential <Object>] [-Force] [-Server <Object>] [-Message <Object>] [<CommonParameters>]
```

## DESCRIPTION
The Enable-HPiLOSecurityMessage cmdlet enables the security text message in the iLO Login Banner.
The Login Security Banner feature enables you to configure the security banner displayed on the iLO login screen.
The message on the security banner can be modified using this command.
You must have configure iLO Setting privileges to make changes to the banner.
...
### EXAMPLE 1
```
PS C:\> Enable-HPiLOSecurityMessage
...
Security Message is not provided for the following iLO Server(s):
1.4.217.131
1.4.217.187
1.4.209.53
Use same Security message value for these servers? (Y/N) : Y
Please enter Security Message: administrator
```
...
### EXAMPLE 2
```
PS C:\> Enable-HPiLOSecurityMessage -Server $Server -Message $message
...
$Server is passed as parameter to Enable-HPiLOSecurityMessage.
...
### EXAMPLE 3
```
PS C:\> Enable-HPiLOSecurityMessage -Server $Server -Username $Username -Password $Password -Message $message
```

This example shows that the list of iLO server addresses is passed as a parameter along with usernames, passwords and security message values.
...
### -Message
This will be the security message that will be displayed to the users in the iLO login banner.
...
Without this parameter, Enable-HPiLOSecurityMessage requires you to provide the values of all required parameters.
