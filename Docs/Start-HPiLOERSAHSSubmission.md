...
```
Start-HPiLOERSAHSSubmission [-OutputType <String>] [-Username <Object>] [-Password <Object>]
 [-Credential <Object>] [-Force] [-Server <Object>] [-MessageID <Object>] [-BBDays <Object>]
 [<CommonParameters>]
```

## DESCRIPTION
The Start-HPiLOERSAHSSubmission cmdlet initiates Active Health System data submission to the Insight Remote Support server.
...
### EXAMPLE 1
```
PS C:\> Start-HPiLOERSAHSSubmission
...
BB Days is not provided for the following iLO Server(s):
1.4.217.131
1.4.217.187
1.4.209.53
Use same BB Days value for these servers? (Y/N) : N
Enter BB Days value for 1.4.217.131: 4
Enter BB Days value for 1.4.217.187: 4
Enter BB Days value for 1.4.209.53: 3
```
...
### EXAMPLE 2
```
PS C:\> Start-HPiLOERSAHSSubmission -Server $Server
...
1.4.217.187
1.4.209.53
Use same BB Days for these servers? (Y/N) : N
Enter BB Days for 1.4.217.131: 4
Enter BB Days for 1.4.217.187: 4
Enter BB Days for 1.4.209.53: 3
```

$Server is passed as parameter to Start-HPiLOERSAHSSubmission.
...
### EXAMPLE 3
```
PS C:\> Start-HPiLOERSAHSSubmission -Server $Server -Username $Username -Password $Password -MessageID $MessageID -BBDays $BBDays
```
...
### -MessageID
It is a UUID format used to match the Active Health System package with the request.
...
### -BBDays
It is the number of days to include in the transmission, up to a maximum of the last seven days not including the present day.
...
Without this parameter, Start-HPiLOERSAHSSubmission requires you to provide the values of all required parameters.
