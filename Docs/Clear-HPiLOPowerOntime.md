...
```
Clear-HPiLOPowerOntime [-OutputType <String>] [-Username <Object>] [-Password <Object>] [-Credential <Object>]
 [-Force] [-Server <Object>] [<CommonParameters>]
```

## DESCRIPTION
The Clear-HPiLOPowerOnTime cmdlet clears the virtual clock counter without power-cycling the server.
...
### EXAMPLE 2
```
PS C:\> Clear-HPiLOPowerOntime -Server $server
...
$Server is passed as parameter to Clear-HPiLOPowerOntime.
...
### EXAMPLE 3
```
PS C:\> Clear-HPiLOPowerOntime -Server $Server -Username $Username -Password $Password
```
...
Without this parameter, Clear-HPiLOPowerOntime requires you to provide the values of all required parameters.
